            ...
            <div class="container">
                <div class="row g-5 gy-3 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        <h1 class="mb-4">Usted es Propietario?</h1>
                        <p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet</p>
                        <p><i class="fa fa-check text-primary me-3"></i>Tempor erat elitr rebum at clita</p>
                        <p><i class="fa fa-check text-primary me-3"></i>Aliqu diam amet diam et eos</p>
                        <p><i class="fa fa-check text-primary me-3"></i>Clita duo justo magna dolore erat amet</p>
                        <div class="d-flex justify-content-around">
                            <a class="btn btn-primary py-3 px-5" href="{{ url('soy-propietario') }}">Nuestros Servicios</a>
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.2s">
                        ...
                        <p><i class="fa fa-check text-primary me-3"></i>Clita duo justo magna dolore erat amet</p>
                        <div class="d-flex justify-content-around">
                            <a class="btn btn-primary py-3 px-5" href="{{ url('soy-viajero') }}">Nuestros Servicios</a>
                            <a class="btn btn-secondary py-3 px-5" href="">Casas Disponibles</a>
                        </div>
                    </div>
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.6s">
                        <div class="about-img position-relative overflow-hidden p-5 pe-0">
                            <img class="img-fluid w-100" src="{{ asset('img/turista.jpg') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        <h1 class="mb-4">Eres Futuro Viajero o Habitante?</h1>
                        <p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet</p>
                        <p><i class="fa fa-check text-primary me-3"></i>Tempor erat elitr rebum at clita</p>
                        <p><i class="fa fa-check text-primary me-3"></i>Aliqu diam amet diam et eos</p>
                        <p><i class="fa fa-check text-primary me-3"></i>Clita duo justo magna dolore erat amet</p>
                        <div class="d-flex justify-content-around">
                            <a class="btn btn-primary py-3 px-5" href="{{ url('soy-futuro-turista-o-habitante') }}">Nuestros Servicios</a>
                            <a class="btn btn-secondary py-3 px-5" href="">Casas Disponibles</a>
                        </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3">Nuestros Clientes</h1>
